    ...
    if (!err && res.statusCode === 200) {
      ...
      request(option, (err, res, body) => {
        if (!err && res.statusCode === 200) {
          ...
          resultCity.humidity = city_weather.consolidated_weather[0].humidity;
          resultCity.consolidated_weather = city_weather.consolidated_weather;
          cities.push(resultCity);
          console.log("metaweather resultCity=", JSON.stringify(resultCity));
